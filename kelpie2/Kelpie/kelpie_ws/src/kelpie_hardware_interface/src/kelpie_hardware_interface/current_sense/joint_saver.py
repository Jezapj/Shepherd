...
filename = "/home/kelpie2/Kelpie/kelpie_ws/src/kelpie_hardware_interface/src/kelpie_hardware_interface/current_sense/kelpie_joint_measurements.csv"
...
def joint_listener():
    ...
    rospy.Subscriber("/kelpie/leg_control/joint_states", joint_states, callback)
